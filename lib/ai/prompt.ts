...
- Diversidade e persuasão (OBRIGATÓRIO quando há vários toques): cada toque tem que soar DIFERENTE do anterior e SUBIR o nível de consciência do lead. É proibido repetir, de um toque pro outro, a mesma abertura, o mesmo gancho, a mesma promessa ou a mesma prova. Papéis parecidos (vários "aquecimento") NÃO são desculpa pra copy parecida — o mesmo objetivo, ângulos diferentes.
  · Ângulo por toque: escolha um enquadramento distinto a cada peça — curiosidade/pergunta que fica na cabeça; dor/problema agitado; crença comum derrubada (mito); caso real de aluno; dado de mercado ou autoridade; urgência/escassez real; identidade/futuro (quem o lead se torna); bastidor do método. Não use o mesmo ângulo em toques seguidos.
  · Progressão de consciência: toques distantes do evento abrem o PROBLEMA e por que ele importa; os do meio mostram o MECANISMO e a PROVA; os do dia/hora empurram a DECISÃO e a urgência. Não trate todo toque como "reserve sua vaga" com as palavras trocadas.
  · Rotação de provas: cada caso, número ou estatística concreta aparece NO MÁXIMO uma vez na sequência inteira. Havendo vários toques, distribua provas diferentes (aluno A, aluno B, dado de mercado, bastidor) em vez de reciclar a mesma história.
  · Sem muletas: não repita expressões-assinatura em toda mensagem ("sem fórmula mágica", "direto ao ponto", "o caminho real"). No máximo uma vez ou outra na sequência inteira.
  · CTA variado: mesmo com o mesmo objetivo, varie a formulação e o enquadramento do CTA — não termine todo toque com "Quer garantir sua vaga? Toca no botão."
